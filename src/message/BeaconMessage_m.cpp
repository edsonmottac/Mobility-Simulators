...
void BeaconMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->alerts);
}
...
const char * BeaconMessage::getAlerts() const
{
    return this->alerts.c_str();
}

void BeaconMessage::setAlerts(const char * alerts)
{
    this->alerts = alerts;
}
...
int BeaconMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='l' && strcmp(fieldName, "lenRoad")==0) return base+6;
    if (fieldName[0]=='s' && strcmp(fieldName, "speed")==0) return base+7;
    if (fieldName[0]=='a' && strcmp(fieldName, "alerts")==0) return base+8;
...
std::string BeaconMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 8: return oppstring2string(pp->getAlerts());
        default: return "";
    }
}
...
bool BeaconMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 8: pp->setAlerts((value)); return true;
